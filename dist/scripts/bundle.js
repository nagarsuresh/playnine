...
var AnswerFrame = React.createClass({displayName: "AnswerFrame",
    render: function () {
        ...
        var numbers = this.props.selectedNumbers.map(function (number) {
            return (
                React.createElement("div", {className: "number", onClick: me.props.deselectHandler.bind(null, number)}, number)
            );
        });
...
var ButtonFrame = React.createClass({displayName: "ButtonFrame",
    render: function () {
        ...
        var button = React.createElement("button", {className: "btn btn-primary btn-lg", disabled: disabled, onClick: checkAnswreHandler}, " = ");
        switch (correct) {
            case true:
                button = React.createElement("button", {className: "btn btn-primary btn-success btn-lg", onClick: this.props.acceptAnswer}, 
                    React.createElement("span", {className: "glyphicon glyphicon-ok"})
                );
                break;
            case false:
                button = React.createElement("button", {className: "btn btn-primary btn-danger btn-lg"}, 
        ...
        return (
            React.createElement("div", {id: "button-frame"}, 
                ...
                React.createElement("br", null), 
                React.createElement("button", {className: "btn btn-warning btn-xs", onClick: this.props.redraw, disabled: this.props.redraws === 0}, 
...
var DoneFrame = React.createClass({displayName: "DoneFrame",
    ...
    render: function () {
        return (
            React.createElement("div", {id: "done-frame", className: "well text-center "}, 
                React.createElement("h2", null, this.props.doneStatus), 
                React.createElement("button", {className: "btn btn-default", onClick: this.props.playAgain}, "Play Again!")
            )
        );
    }
});
...
var Game = React.createClass({displayName: "Game",
    ...
    render: function () {
        ...
        if (doneStatus) {
            bottomFrame = React.createElement(DoneFrame, {doneStatus: doneStatus, playAgain: this.playAgain});
        } else {
            bottomFrame = React.createElement(NumbersFrame, {selectedNumbers: selectedNumbers, selectHandler: this.selectHandler, usedNumbers: usedNumbers});
        }

        return (
            React.createElement("div", {id: "game_container", className: "container"}, 
                ...
                React.createElement("div", {className: "clearfix"}, 
                    ...
                    React.createElement(AnswerFrame, {selectedNumbers: selectedNumbers, deselectHandler: this.deselectHandler})
                ), 
...
},{"./AnswerFrame":158,"./ButtonFrame":159,"./DoneFrame":160,"./NumbersFrame":162,"./StarsFrame":163,"react":157}],162:[function(require,module,exports){
"use strict";
...
var NumbersFrame = React.createClass({displayName: "NumbersFrame",
    ...
    render: function () {
        ...
        for (var i = 1; i <= 9; i++) {
            ...
            numbers.push(
                React.createElement("div", {className: className, onClick: this.props.selectHandler.bind(null, i)}, i)
            );
        }
        return (
...
},{"./components/Game":161,"jquery":1,"react":157}]},{},[164]);
